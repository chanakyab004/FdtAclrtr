ALTER TABLE  `subscriptionPricing` ADD  `totalOccurrences` INT( 11 ) NULL AFTER  `intervalUnit`
...
(2, 1, 'Annual', 2178.00, '$198/month', '$2,001 Total Savings', 10, 'Includes 10 Users', 24.00, '$24 Each Additional User', 1, 'Includes 1 Month Free', 365, 'days', 1, NULL, NULL, 'Annual Subscription Billed Annually', NULL),
(3, 1, 'Annual - Billed Monthly', 198.00, '$198/month', NULL, 10, 'Includes 10 Users', 24.00, '$24 Each Additional User', NULL, NULL, 1, 'months', 12, 1, 297.00, 'Annual Subscription Billed Monthly', NULL);
