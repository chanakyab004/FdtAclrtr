	...
	class BidSent {
		...
		public function getStatus() {
			...
			if (!empty($this->companyID)) {
				...
				$sqlStatement = "(SELECT 'BidSent' AS statusType, 'false' AS customBid, c.firstName, c.lastName, e.evaluationFinalized AS time, j.projectID AS link, p.address, p.address2, p.city, p.state, p.zip FROM 
				...
				(SELECT 'BidSent' AS statusType, 'true' AS customBid, c.firstName, c.lastName, e.evaluationFinalized AS time, j.projectID AS link, p.address, p.address2, p.city, p.state, p.zip FROM 
