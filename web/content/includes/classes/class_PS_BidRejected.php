	...
	class BidRejected {
		...
		public function getStatus() {
			...
			if (!empty($this->companyID)) {
				...
				$sqlStatement = "(SELECT 'BidRejected' AS statusType, 'false' AS customBid, c.firstName, c.lastName, b.BidRejected AS time, j.projectID AS link, p.address, p.address2, p.city, p.state, p.zip, e.evaluationID FROM 
				...
				(SELECT 'BidRejected' AS statusType, 'true' AS customBid, c.firstName, c.lastName, b.BidRejected AS time, j.projectID AS link, p.address, p.address2, p.city, p.state, p.zip, e.evaluationID FROM 
