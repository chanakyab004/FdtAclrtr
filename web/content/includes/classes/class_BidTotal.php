	...
	class BidTotal {
		...
		public function getEvaluation() {
			...
			if (!empty($this->evaluationID)) {
				...
				wallStiffenerNorth, wallStiffenerWest, wallStiffenerSouth, wallStiffenerEast, wallAnchorsNorth, wallAnchorsWest, wallAnchorsSouth, wallAnchorsEast, wallExcavationNorth, 
				wallExcavationWest, wallExcavationSouth, wallExcavationEast, beamPocketsNorth, beamPocketsWest, beamPocketsSouth, beamPocketsEast, windowWellReplacedNorth, 
				windowWellReplacedWest, windowWellReplacedSouth, windowWellReplacedEast, sumpPump, interiorDrainNorth, interiorDrainWest, interiorDrainSouth, 
				...
				exteriorGradingEast, existingSupportPosts, newSupportPosts, floorCracks, wallCracksNorth, wallCracksWest, wallCracksSouth, wallCracksEast, mudjacking, polyurethaneFoam, customServices, otherServices,
