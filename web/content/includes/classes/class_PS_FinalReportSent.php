	...
	class FinalReportSent {
		...
		public function getStatus() {
			...
			if (!empty($this->companyID)) {
				...
				$sqlStatement = "(SELECT 'FinalReportSent' AS statusType, c.firstName, c.lastName, e.finalReportSent AS time, j.projectID AS link, p.address, p.address2, p.city, p.state, p.zip, s.projectScheduleID, s.scheduleType FROM 
				...
				(SELECT 'FinalReportSent' AS statusType, c.firstName, c.lastName, e.finalReportSent AS time, j.projectID AS link, p.address, p.address2, p.city, p.state, p.zip, s.projectScheduleID, s.scheduleType FROM 
