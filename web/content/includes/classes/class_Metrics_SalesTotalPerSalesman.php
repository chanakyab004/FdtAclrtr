	...
	class Metrics {
		...
		public function getMetrics() {
			...
			if (!empty($this->companyID)) {
				...
				$st = $this->db->prepare("SELECT SUM(total) as total, sales, projectSalesperson, calendarBgColor 
					FROM(
						(SELECT p.projectSalesperson, CONCAT( u.userFirstName,' ', u.userLastName) AS sales, bidTotal AS total, u.calendarBgColor
				...
				if ($st->rowCount()>=1) {
					...
					$data['title'] = 'Sales Total Per Salesman';
