<?php
  ...
  class SendBidFirstViewed {
    ...
    public function setBid($evaluationID) {
    ...
    public function sendEmail($userEmail, $projectID, $customerFirstName, $customerLastName, $firstName, $lastName ){
                      ...
                      <table class=\"email-body_inner\" align=\"center\" width=\"570\" cellpadding=\"0\" cellspacing=\"0\">
                        ...
                        <tr>
                          <td class=\"content-cell\">
                            ...
                            <p>".$customerFirstName." ".$customerLastName. " has viewed your bid.</p>
                            <p>".$viewProjectLink."</p>
                          </td>
                        </tr>
                      </table>
      ...
      $altbody = "Hello ".$firstName.",
                ".$customerFirstName." ".$customerLastName. " has viewed your bid.
                ".$viewProjectLink.""; 
        ...
        $Mail->CharSet     = 'UTF-8';
        $Mail->Encoding    = '8bit';
        $Mail->Subject     = 'Bid Has Been Viewed';
