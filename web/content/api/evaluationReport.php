<?php
	...
	if (empty($response) || $response['message'] != 'success' || empty($evaluationID)){
		...
		include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_Company.php');
			...
			if (!empty($companyLogo)) {
				$logo = $_SERVER['DOCUMENT_ROOT'] . "/assets/company/".$companyID."/".$companyLogo."";
		...
		//Phone	
		include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_CompanyPhone.php');
	...
	include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_EvaluationProject.php');
	 ...
	 include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_CustomerPhone.php');
	...
	include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_CompanyServices.php');
	...
	if (empty($customEvaluation)) {
		include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_EvaluationTables.php');
			...
			include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_FloorCrackRepair.php');
			...
			if (!empty($floorCrackArray)) {
				...
				if (!empty($floorCracksArray)) {
					foreach($floorCracksArray as $row) {
						...
						$floorCracksEachDisplay .= ''.$cracklength.' LF of '.$crackRepairName.', ';
					}
				...
				$floorCracksDisplay = '
					<strong>Floor Cracks:</strong> '.$floorCracksEachDisplay.'<br/>'.$floorCrackNotes;
					
			}
			}
			
		include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_WallCrackRepair.php');
			...
			if (!empty($crackArray)) {
				...
				if (!empty($northCracksArray)) {
					foreach($northCracksArray as $row) {
						...
						$northWallCracksEachDisplay .= ''.$cracklength.' Linear Feet, ';
					}
				...
				if (!empty($westCracksArray)) {
					foreach($westCracksArray as $row) {
						...
						$westWallCracksEachDisplay .= ''.$cracklength.' Linear Feet, ';
					}
				...
				if (!empty($southCracksArray)) {
					foreach($southCracksArray as $row) {
						...
						$southWallCracksEachDisplay .= ''.$cracklength.' Linear Feet, ';
					}
				...
				if (!empty($eastCracksArray)) {
					foreach($eastCracksArray as $row) {
						...
						$eastWallCracksEachDisplay .= ''.$cracklength.' Linear Feet, ';
					}
		...
		include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_PierData.php');
		...
		include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_Mudjacking.php');
		...
		include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_PolyurethaneFoam.php');
		...
		include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_CustomServices.php');
		...
		include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_OtherServices.php');
		...
		include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_EvaluationDisclaimer.php');
		...
		include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_PostExist.php');
		...
		include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_PostNew.php');
	...
	include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_SumpPumps.php');
		...
		include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/classes/class_Obstructions.php');
			...
			if (!empty($array)) {
				...
				if (!empty($front)) {
					...
					foreach($frontArray as &$photo) {
						...
						list($width, $height) = getimagesize($_SERVER['DOCUMENT_ROOT'] . '/assets/company/'.$companyID.'/projects/'.$projectID.'/evaluations/'.$evaluationID.'/images/'.$photo.'');
							 
							 
							 if ($width == $height) { 
							 	//Square
							 	$newPhoto = '<img style="border:1px solid #000; padding:.5rem;" src="' . $_SERVER['DOCUMENT_ROOT'] . '/assets/company/'.$companyID.'/projects/'.$projectID.'/evaluations/'.$evaluationID.'/images/'.$photo.'" width="250" height="250"';
								$newWidth = '250px';
							 }
							 
							 if ($width > $height) { 
							 	//Landscape
								$newPhoto = '<img style="border:1px solid #000; padding:.5rem;" src="' . $_SERVER['DOCUMENT_ROOT'] . '/assets/company/'.$companyID.'/projects/'.$projectID.'/evaluations/'.$evaluationID.'/images/'.$photo.'" width="350"';
								$newWidth = '350px';
							 }
							 
							 if ($width < $height) { 
							 	//Portrait
								$newPhoto = '<img style="border:1px solid #000; padding:.5rem;" src="' . $_SERVER['DOCUMENT_ROOT'] . '/assets/company/'.$companyID.'/projects/'.$projectID.'/evaluations/'.$evaluationID.'/images/'.$photo.'" width="250"';
								$newWidth = '250px';
							 }
