<?php
	...
	include_once('includes/classes/class_CompanySubscription.php');
		...
		$titleDisplay = $subscriptionArray['titleDisplay'];
		...
		$totalOccurrences = $subscriptionArray['totalOccurrences'];
		...
		$setupFee = $subscriptionArray['setupFee'];
		$isSetupFeeWaived = $subscriptionArray['isSetupFeeWaived'];
		$isBestDeal = $subscriptionArray['isBestDeal'];
		$subscriptionNextBill = $subscriptionArray['subscriptionNextBill'];
		...
		$subscriptionNextBill = date('F j, Y', strtotime($subscriptionNextBill)); 
		...
		if ($subscriptionPricingID != '') {
			if ($subscriptionType == 1) {
				...
				$subscriptionDisplay = '
	                ...
	                <p class="nextBillingTitle" style="margin-bottom:0;"><strong>Subscription Expires</strong></p></strong>
	                <p class="expirationDate" style="margin-bottom:1rem;">
	                    '.$currentExpiration.'
	                </p>
	                <p class="nextBillingTitle" style="margin-bottom:0;"><strong>Next Billing</strong></p></strong>
